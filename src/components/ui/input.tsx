  ...
  return (
    <input
      ...
      className={cn(
        ...
        isTimeInput &&
          "h-11 rounded-2xl bg-card pr-2 font-medium tabular-nums tracking-[0.01em] dark:bg-input/20 [&::-webkit-calendar-picker-indicator]:cursor-pointer [&::-webkit-calendar-picker-indicator]:opacity-75 hover:[&::-webkit-calendar-picker-indicator]:opacity-100",
        className
      )}
      {...props}
    />
