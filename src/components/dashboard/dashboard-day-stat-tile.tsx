...
export function DashboardDayStatTile({
  ...
  return (
    <Link
      href={href}
      className={cn(
        "flex min-h-[4.75rem] touch-manipulation flex-col rounded-2xl border border-border bg-card px-3 py-3 shadow-sm shadow-slate-900/5 outline-none transition-colors hover:border-primary/40 hover:bg-muted/25 focus-visible:ring-2 focus-visible:ring-ring",
        className,
      )}
    >
