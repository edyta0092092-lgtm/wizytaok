...
{{nazwa_firmy}}`,
    ...
    onboarding: {
      ...
      staffWelcomeTitle: "Witaj w panelu",
      staffWelcomeLead:
        "W kilku krótkich krokach poznasz plan dnia, wizyty i narzędzia dostępne dla Twojej roli.",
      cardTitle: "Konfiguracja firmy",
      cardLead: "Dokończ setup, aby przyjmować rezerwacje online.",
      staffCardTitle: "Pierwsze kroki w panelu",
      staffCardLead: "Poznaj podstawowe zakładki — plan dnia, wizyty, grafik i pomoc.",
...
{{nazwa_firmy}}`,
    ...
    onboarding: {
      ...
      staffWelcomeTitle: "Welcome to the panel",
      staffWelcomeLead:
        "In a few short steps you will learn the day plan, visits and tools available for your role.",
      cardTitle: "Business setup",
      cardLead: "Finish setup to start accepting online bookings.",
      staffCardTitle: "First steps in the panel",
      staffCardLead: "Learn the basics — day plan, visits, schedule and help.",
